...
Ipr = 1.e3 * np.asarray([ 0.02,0.19,0.21,
                0.53,1.21,2.39,2.94,3.30,3.47,
                3.60,4.14,4.41,4.58,4.63,4.66,4.67,4.62,4.55,4.44,4.22,
                4.08,3.63,3.24,2.90,2.52,2.24,1.97,1.58,1.26,1.01,0.84,
                0.56,0.40,0.27,0.18,0.081,0.041,0.0135,0.0057])
Ipr_unit = r'W m$^{-2}$ sr$^{-1}$ $\AA^{-1}$'


## smoothed version 
#print(' using smoothed version of Allen intensity')
#Ipr = 1.e3 * np.asarray([ 0.014,0.13,0.13,0.37,0.60,1.34,1.67,1.89,1.96,2.28,2.16,
#                2.08,2.97,33.8,3.45,3.12,3.61,3.87,3.95,3.84,
#                3.61,3.43,3.17,2.81,2.46,2.18,                          
#                1.94,1.57,1.25,1.01,0.84,
#                0.56,0.40,0.27,0.18,0.081,0.041,0.0135,0.0057])
#Ipr_unit = r'W m$^{-2}$ sr$^{-1}$ $\AA^{-1}$'
